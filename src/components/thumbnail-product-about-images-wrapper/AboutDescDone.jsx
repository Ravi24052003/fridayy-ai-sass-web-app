  ...
  return (
    <>
      <div style={{ overflowX: "hidden"}} className='pb-[100px]' >
        ...
        {/* image and Button Box starts here  */}
        <Box sx={{mt: "40px", display: "flex", flexDirection: "column", alignItems: "center"}} >
            <img src={props?.bannerImg?.bannerImageUrl} alt="" />
      ...
      sx={{ color: 'black', py: "8px", borderRadius: '20px', border: '1px solid gray', backgroundColor: "rgba(224, 224, 224, 0.1)", my: "10px", textTransform: "none", fontSize: "16px" }}
    >
      Replace Image
    </Button>

        </Box>
       {/* image and Button Box ends here  */}
