...
const Guide24 = (props) => {
  ...
  const steps = [
    {
      target: '.logo',
      content: 'Here will be the logo of your company',
    },
    {
      target: '.image',
      content: 'Here will be an image of your company',
    },
    {
      target: '.company-name',
      content: 'Here will be the name of your company',
    },
    {
      target: '.description',
      content: 'Here will be a brief description about your company',
    },
  ];


  const handleGuideStep = function(){
    props.setGuideStep(2)
  }

  return (
    <>
      <div className='bg-gradient-to-b from-[#299585] to-[#59ccb7] md:pb-[100px] pb-[20px]'>
        ...
        <Box style={{ width: '100%', minHeight: '100vh' }}>
          ...
          <div className='w-[90%] mx-auto md:w-[380px] my-[150px] md:my-[25px]'>
            <div className='bg-gray-800 flex justify-center py-2 logo'>
