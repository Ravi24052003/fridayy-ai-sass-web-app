  ...
  return (
    ...
    <div style={{ overflowX: "hidden"}} className='pb-[100px]' >
       ...
       <div className=' flex flex-col items-center mt-12'>
        ...
        <Typography sx={{fontSize: "18px", color: "#299585", fontWeight: 600, textAlign: "center"}} >Generating Selected Catalog for further process...</Typography>
       </div>
